        ...
        projects_data = [
            {
                ...
                "overview": [
                    ...
                    " AcaSmart را به عنوان یک اپ دسکتاپ کراس‌پلتفرم با Python، PySide6 و SQLite پیاده‌سازی کردم تا مدیریت هنرجو، استاد، کلاس، جلسه و پیامک یادآوری در یک سیستم یکپارچه انجام شود.",
            ...
            },
            {
                ...
                "overview": [
                    ...
                    " وب‌سایت آکادمی آرامش را با Django پیاده‌سازی کردم تا صفحات، گالری، اساتید و برنامه کلاس‌ها از پنل مدیریت به‌روزرسانی شود.",
                    ...
                    " تیم آموزشگاه محتوای سایت را از طریق پنل مدیریت به‌روزرسانی می‌کند و مسیر ارتباطی هنرجوها رسمی‌تر شده است.",
                ],
                "features": [
                    {
                    ...
                    },
                    {
                        ...
                        "description": "افزودن و ویرایش گالری از پنل مدیریت.",
                    },
                    {
            ...
            },
            {
                ...
                "overview": [
                    ...
                    " با Django 5 و PostgreSQL یک وب‌اپلیکیشن ساختم؛ احراز هویت با شماره موبایل و کد یک‌بارمصرف، کاتالوگ محصولات بر اساس دسته‌بندی دام، سبد خرید و چرخه‌ی سفارش، نسخه و درخواست تمدید دارو، نوبت‌دهی با تأیید کارکنان، و ثبت سوابق ویزیت و واکسیناسیون را پیاده‌سازی کردم.",
                    " لایه‌ی اعلان را پشت یک رابط قابل جایگزینی نوشتم تا بک‌اند پیامک یا ایمیل بدون تغییر کد فراخوان عوض شود، یادآوری واکسن را با یک دستور مدیریتی زمان‌بندی‌شده اجرا کردم، و تنظیمات را به سه لایه‌ی base/dev/prod تقسیم کردم تا SQLite در توسعه و PostgreSQL در انتشار اجرا شود.",
                    " انتشار روی Runflare پیکربندی شده و پروژه در حال تکمیل اطلاعات نهایی سمت کارفرما پیش از راه‌اندازی رسمی است.",
                ],
                "features": [
                    {
